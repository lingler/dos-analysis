...
class Dos:
    ...
    def get_spin(self):
        ...
        spin = int(xml.xpath(spin_path)[0].strip())
        return spin
    ...
    def get_one_ion_pdos(self, ion_index, spin, orbitals=[]):
        ...
        ion_dos_datas = xml.xpath(one_ion_path)
    ...
    def get_column_names(self):
        ...
        column_names = xml.xpath(column_name_path)
